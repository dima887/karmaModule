...
@section('content')
    ...
    {{--						<a href="../shop/category.blade.php">Login/Register</a>--}}
    {{--					</nav>--}}
    {{--				</div>--}}
    {{--			</div>--}}
    {{--		</div>--}}
                ...
                <div class="col-lg-6">
                    <div class="login_box_img">
                        ...
                        <div class="hover">
                            ...
                            <a class="primary-btn" href="{{route('registerUser')}}">Создать новый аккаунт</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login_form_inner">
                        ...
                        <form class="row login_form" action="{{route('authUser')}}" method="post" id="contactForm"
                            ...
                            <div class="col-md-12 form-group">
                                <div class="creat_account">
                                    <input type="checkbox" id="f-option2" name="remember_token" value="1">
